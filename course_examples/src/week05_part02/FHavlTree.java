...
extends FHsearch_tree<E>
{
   ...
   protected FHs_treeNode<E> rotateWithLeftChild( 
      FHs_treeNode<E> k1 )
   {
      FHs_treeNode<E> k2 = k1.lftChild;
      k1.lftChild = k2.rtChild;
      k2.rtChild = k1;
      k1.setHeight( Math.max( heightOf(k1.lftChild),  heightOf(k1.rtChild) ) + 1 );
      k2.setHeight( Math.max( heightOf(k2.lftChild),  k1.getHeight() ) + 1 );
      return k2;
   }
   ...
   protected FHs_treeNode<E> rotateWithRightChild( 
      FHs_treeNode<E> k1 )
   {
      FHs_treeNode<E> k2 = k1.rtChild;
      k1.rtChild = k2.lftChild;
      k2.lftChild = k1;
      k1.setHeight( Math.max( heightOf(k1.lftChild),  heightOf(k1.rtChild) ) + 1 );
      k2.setHeight( Math.max( heightOf(k2.rtChild),  k1.getHeight() ) + 1 );
      return k2;
   }
