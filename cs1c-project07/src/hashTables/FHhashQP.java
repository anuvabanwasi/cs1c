...
// FHhashQP class --------------------------------------------
/**
 * Hash table implementation that uses quadratic probing to resolve collisions
 * @author Anuva
 *
 * @param <E> data type of object to be stored in the hash table
 */
public class FHhashQP<E>
{
    ...
    * @param x object to insert into the hash table
    * @return true if x was successfully added to the hash table
    */
   public boolean insert( E x)
   {
      int bucket = findPos(x);
      
      //System.out.println("\t\t inserting bucket " + bucket);
    ...
    * @param x object to be hashed
    * @return hash code representing index in the table corresponding to the key
    */
