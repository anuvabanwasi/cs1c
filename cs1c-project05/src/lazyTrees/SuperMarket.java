...
public class SuperMarket 
{
	...
	public static void main(String[] args) 
	{
		...
		// NOTE: An example of testing the boundary condition when removing all items from inventory and findMin() and findMax() output when tree is empty
		//final String TESTFILE = "resources/inventory_all_delete.txt";	

		// NOTE: An example of testing the boundary condition when no items are removed from inventory
		//final String TESTFILE = "resources/inventory_no_delete.txt";	

		// NOTE: An example of testing the boundary condition when nodes with 2 children, 1 children or no children are deleted
		//final String TESTFILE = "resources/inventory_test_deletion_all.txt";	
